...
import { promptImageCandidates, PromptCover } from "./prompt-cover";
        ...
        <Card
            ...
            cover={
                <button type="button" className="block w-full text-left" onClick={onOpen}>
                    <PromptCover sources={promptImageCandidates(item.coverUrl)} alt={item.title} className="aspect-[4/3] w-full bg-stone-100 object-contain dark:bg-stone-900" />
                </button>
            }
        >
            <button type="button" className="block w-full text-left" onClick={onOpen}>
