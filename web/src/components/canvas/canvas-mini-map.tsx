...
export function Minimap({ nodes, viewport, viewportSize, onViewportChange }: { nodes: CanvasNodeData[]; viewport: ViewportTransform; viewportSize: { width: number; height: number }; onViewportChange: (viewport: ViewportTransform) => void }) {
    ...
    return (
        <div className="canvas-liquid-glass canvas-liquid-glass-surface canvas-liquid-glass-absolute bottom-40 left-4 z-50 overflow-hidden rounded-lg sm:bottom-24 sm:left-6" style={{ width, height }}>
            <div
                ref={containerRef}
