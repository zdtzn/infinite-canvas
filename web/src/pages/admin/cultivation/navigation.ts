export type AdminSectionKey = "overview" | "users" | "rules" | "capabilities" | "announcements" | "monitoring" | "records";
...
export function resolveAdminSection(value: string | null): AdminSectionKey {
    if (value === "users" || value === "overview" || value === "rules" || value === "capabilities" || value === "announcements" || value === "monitoring" || value === "records") return value;
