...
test("covers the main user-facing Infinite Canvas workflows", () => {
    ...
    for (const required of ["getting-started", "canvas", "image-workbench", "product-lab", "prompts", "assets", "cultivation", "configuration", "task-center", "canvas-agent", "data-and-account", "faq"]) {
