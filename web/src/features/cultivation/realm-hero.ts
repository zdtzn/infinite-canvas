...
const realmVisual = (realmId: string) => ({
    badgeSrc: realmAsset(`badges/${realmId}-badge.webp`),
    auraSrc: realmAsset(`badges/${realmId}-aura.webp`),
});

const fallbackRealmHero: RealmHeroTheme = {
    ...realmVisual("realm-dou-qi"),
